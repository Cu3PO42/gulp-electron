      ...
      return new Promise(function(resolve, reject) {
        return Promise.resolve().then(function() {
          ...
          if (platform.indexOf('darwin') >= 0 && (((ref2 = options.platformResources) != null ? ref2.darwin : void 0) != null)) {
            ...
            return distributePlist(options.platformResources.darwin, targetAppPath);
          }
        }).then(function() {
          var ref2, ref3;
...
download = function(cacheFile, cachePath, version, cacheZip) {
  ...
  return new Promise(function(resolve, reject) {
    ...
    bar = null;
    return request("https://github.com/atom/electron/releases/download/" + version + "/" + cacheZip).on('error', function(error) {
...
distributePlist = function(options, targetAppPath) {
  return new Promise(function(resolve) {
    var contentsPlist, contentsPlistDir, helperPlist, helperPlistDir;
